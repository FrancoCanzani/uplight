/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58972358e90fa485e173d100106beb5a)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "CheckerDO";
	}
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		DOMAIN_CHECKER_URL: string;
		VITE_DOMAIN_CHECKER_URL: string;
		AI_GATEWAY_API_KEY: string;
		ENCRYPTION_SECRET: string;
		CHECKER: DurableObjectNamespace<import("./src/backend/index").CheckerDO>;
		status_page_logos: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DOMAIN_CHECKER_URL" | "VITE_DOMAIN_CHECKER_URL" | "AI_GATEWAY_API_KEY" | "ENCRYPTION_SECRET">> {}
}
