...
INSERT INTO `__new_incident`("id", "monitor_id", "cause", "title", "description", "hint", "severity", "status", "post_mortem_title", "post_mortem_content", "started_at", "acknowledged_at", "fixing_at", "resolved_at") SELECT "id", "monitor_id", "cause", "title", "description", "hint", "severity", "status", "post_mortem_title", "post_mortem_content", "started_at", "acknowledged_at", "fixing_at", "resolved_at" FROM `incident`;--> statement-breakpoint
