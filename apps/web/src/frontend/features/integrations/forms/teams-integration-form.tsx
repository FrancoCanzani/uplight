...
import type { Integration, TeamsFormInput } from "../schemas";
import { TeamsFormSchema } from "../schemas";

function getDefaultValues(existing?: Integration): TeamsFormInput {
  if (existing && existing.type === "teams") {
    return {
      type: "teams",
